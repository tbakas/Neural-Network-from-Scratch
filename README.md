...
The Jupyter notebook uses engine.py to create an MLP model and uses it to predict handwritten digits from the MNIST digit dataset. It achieves a 95.5% accuracy on a test set after 30 epochs of training with vanilla gradient descent.
